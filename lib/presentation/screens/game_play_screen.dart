...
class _GamePlayScreenState extends State<GamePlayScreen>
  ...
  void initState() {
    ...
    _setupAnimations();
    _initializePhase();
    _addToHistory('Game started in ${_getPhaseDisplayName(_currentSession.currentPhase)} phase');
  }
  ...
  void _showPhaseCompleteDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('${_getPhaseDisplayName(_currentSession.currentPhase)} Complete'),
        content: Text(
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            color: _getPhaseColor(_currentSession.currentPhase).withOpacity(0.1),
  ...
  Widget _buildPhaseControls() {
    return Column(
      children: [
        if (_currentSession.currentPhase == GamePhase.description && _descriptionTimePerPlayer > 0) ...[
          PrimaryButton(
